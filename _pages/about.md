...
redirect_from: 
  ...
  - /about.html
---
I am a [PhD student](https://www.ling.upenn.edu/people/pristina-koon) in the [University of Pennsylvania's Department of Linguistics](https://www.ling.upenn.edu/). Before coming to Penn, I graduated from the University of Michigan with a BA in [linguistics](https://lsa.umich.edu/linguistics) and [Asian studies (Southeast Asia submajor)](https://lsa.umich.edu/asian). My research interests are centered around language contact with an emphasis on contact-induced change of morphology, so I am lucky to be co-advised by Professors [Marlyse Baptista](https://web.sas.upenn.edu/language-contact-cognition-lab/) and [David Embick](https://web.sas.upenn.edu/embick-lab/). I am specifically interested in morphological multifunctionality and innovation in creole and pidgin languages that have Malay or Tagalog as a source language. My current work is focused most heavily on Betawi.
